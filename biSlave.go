...
var myName                = "Sat-A"  //tbConfig.TBexpMgrName
var myFullName            tbMessages.NameId
var myUdpAddress          = new(net.UDPAddr)
var myIpAddress           = ""
var myIPandPort           = "" //"10.0.1.210" + ":" + tbConfig.BifrostPort
var mastersIPandPort      = "" // "10.0.1.165" + ":" + tbConfig.BifrostPort
...
func myInit() {
	...
	myIPandPort = myIpAddress + ":" + tbConfig.BifrostPort
	...
	theMgr :=  locateOtherSatellite(sliceOfOtherSatellites, tbConfig.BifrostSlave)
	if theMgr != nil {
		fmt.Println(myName,"SAT:",theMgr.Name.Name, "ADDRESS:",theMgr.Name.Address,
...
func sendRegisterMsg() {
	theMgr := locateOtherSatellite(sliceOfOtherSatellites, myURL)
